...
ON public.sar_drafts FOR SELECT
USING (true);

CREATE POLICY "Public insert drafts"
ON public.sar_drafts FOR INSERT
WITH CHECK (true);

CREATE POLICY "Public update drafts"
ON public.sar_drafts FOR UPDATE
USING (true);
...
DROP TRIGGER IF EXISTS sar_drafts_updated_at ON public.sar_drafts;
...
VALUES ('sar-proofs', 'sar-proofs', true)
ON CONFLICT (id) DO NOTHING;

-- ✅ STORAGE POLICIES
CREATE POLICY "Public read proofs"
ON storage.objects FOR SELECT
USING (bucket_id = 'sar-proofs');

CREATE POLICY "Public upload proofs"
ON storage.objects FOR INSERT
WITH CHECK (bucket_id = 'sar-proofs');

CREATE POLICY "Public delete proofs"
